  ...
  return (
    <main>
      ...
      <p>
        ...
        to act now. In HOWL, we intend to collectively create a broad picture
        that includes and represents women from all parts of the UK. Our core
        collection years are from 1965 to the 1990s. We will achieve this
        through reaching out to old feminists, creating a website, collecting
        oral histories, gathering memorabilia and holding events. HOWL
