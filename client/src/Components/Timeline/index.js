...
const Timeline = () => {
  ...
  return (
    <main>
      ...
      <p>
        Browse our timeline by using the controls at the bottom of this page to 
      ...
      <p>  
        Prefer a simpler approach? Take a look at the <Link to={ARCHIVE_URL}>archive</Link> for a text-based experience.
      </p>
    </main>
  );
};
