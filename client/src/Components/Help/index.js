      ...
      <main>
        ...
        <SectionCntr>
          ...
          <p>
            ...
            <Highlight>
              {' '}
              section of time, category, location, tags, year, and your own
              search queries
            </Highlight>
            . These options can be viewed one at a time, or in conjunction with
            others. Please be sure to make all of your selections before
            pressing
        ...
        <SectionCntr>
          ...
          <p>
            ...
            then press <Highlight>&quot;Search&quot;</Highlight>, or continue to
            select other parameters first.
          </p>
        ...
        <SectionCntr>
          ...
          <p>
            Clicking on the small arrow on the edge any of these fields will
            give you a list of options to choose from for filtering your search
            results. Click on one to select it. Select one and then press
            <Highlight> &quot;Search&quot;</Highlight>, or continue to select
        ...
        <SectionCntr>
          ...
          <p>
            ...
            will be able to type in your own search queries. DO so, and then
            press
            <Highlight> &quot;Search&quot;</Highlight>, or continue to select
            other parameters first.
          </p>
